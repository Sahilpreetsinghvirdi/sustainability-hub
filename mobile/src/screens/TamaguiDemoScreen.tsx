  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Stack flexDirection="row" justifyContent="space-between" alignItems="center" marginBottom={spacing.lg}>
        <Stack>
          <Text fontSize={24} fontWeight="800" color="#0A0A0A">Component Demo</Text>
          <Text fontSize={14} color="#6B6B6B" marginTop={4}>All UI components</Text>
        </Stack>
      ...
      <Section title="Cards">
        <Card marginBottom={8}>
          <Text fontSize={16} fontWeight="600" color="#0A0A0A" marginBottom={4}>Default Card</Text>
          <Text fontSize={14} color="#444444">Content with default styling</Text>
        </Card>
        <Card marginBottom={8}>
          <Stack flexDirection="row" justifyContent="space-between" alignItems="center">
            <Text fontSize={16} fontWeight="600" color="#0A0A0A">With Badge</Text>
      ...
      <Section title="Charts">
        <Text fontSize={14} fontWeight="600" color="#0A0A0A" marginBottom={8}>Sparkline</Text>
        <Sparkline data={[10, 15, 13, 17, 22, 20, 25, 28, 24, 30]} color={colors.primary[500]} width={300} height={80} />
        <Text fontSize={14} fontWeight="600" color="#0A0A0A" marginTop={16} marginBottom={8}>Bar Chart</Text>
        <BarChart data={barData} height={180} />
        <Text fontSize={14} fontWeight="600" color="#0A0A0A" marginTop={16} marginBottom={8}>Pie Chart</Text>
      ...
      <Section title="Modal">
        ...
        <Modal visible={modalVisible} onClose={() => setModalVisible(false)} title="Demo Modal">
          <Text color="#444444" marginBottom={12}>This is a modal dialog.</Text>
...
const Section = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <Stack marginBottom={24}>
    <Text fontSize={18} fontWeight="700" color="#0A0A0A" marginBottom={12}>{title}</Text>
    {children}
  </Stack>
);
